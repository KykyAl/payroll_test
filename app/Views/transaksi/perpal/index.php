                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <label class="form-label"><b>Nomer Supir/Kernet</b></label>
                                <select class="form-control" name="kode_supir" id="kode_supir" style="width: 100%;">
                                </select>
                            </div>
                            <div class="col-lg-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea type="text" class="form-control" style="height: 100px;" id="keterangan" placeholder="Keterangan" name="keterangan" required></textarea>
                        </div>

                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <button type="button" class="btn btn-success" id="btnTambah">Simpan</button>
