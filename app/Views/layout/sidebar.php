        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li <?= ((ucfirst($segment2) == 'Crew') ? 'class="active"' : '') ?>><a class="nav-link"
                            href="<?= base_url('master/crew') ?>">Crew</a></li>
                    <?php } ?>
                </ul>
            </li>
            <?php } ?>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li <?= ((ucfirst($segment2) == 'Perpal') ? 'class="active"' : '') ?>><a class="nav-link"
                            href="<?= base_url('transaksi/perpal') ?>">Perpal</a></li>
