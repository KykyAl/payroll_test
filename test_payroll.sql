...
MySQL - 5.6.51 : Database - test_payroll
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`test_payroll` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
(40,21,'email_password',NULL,'admin@gmail.com','$2y$12$J5Rb09FSA503bjQ989KPMe8tE3jibxWrosUyaXcRcwTcAMGF7wM46',NULL,NULL,NULL,'2024-07-03 13:00:51','2024-05-16 09:10:46','2024-07-03 13:00:51'),
...
CREATE TABLE `auth_logins` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_type_identifier` (`id_type`(191),`identifier`(191)),
  KEY `user_id` (`user_id`)
...
CREATE TABLE `perpal` (
  ...
  `jlh_hari_perpal` int(11) DEFAULT NULL,
...
(21,'admin',NULL,NULL,1,'2024-07-03 13:01:01','2024-05-16 09:10:46','2024-05-16 09:10:47',NULL,1,'[\"null\"]',3,NULL);
